package edu.aku.abdulsajid.template.activities;
...
import edu.aku.abdulsajid.template.R;
import edu.aku.abdulsajid.template.RMOperations.crudOperations;
import edu.aku.abdulsajid.template.core.MainApp;
import edu.aku.abdulsajid.template.data.DAO.FormsDAO;
import edu.aku.abdulsajid.template.data.DAO.GetFncDAO;
import edu.aku.abdulsajid.template.data.entities.District;
import edu.aku.abdulsajid.template.data.entities.FacilityProvider;
import edu.aku.abdulsajid.template.data.entities.Forms;
import edu.aku.abdulsajid.template.data.entities.Tehsil;
import edu.aku.abdulsajid.template.databinding.ActivityRsdinfoBinding;
import edu.aku.abdulsajid.template.get.db.GetAllDBData;
import edu.aku.abdulsajid.template.get.db.GetIndDBData;
import edu.aku.abdulsajid.template.utils.DateUtils;
import edu.aku.abdulsajid.template.validation.ClearClass;
import edu.aku.abdulsajid.template.validation.validatorClass;
