...
import edu.aku.abdulsajid.template.appVersion.VersionAppContract;
import edu.aku.abdulsajid.template.core.CONSTANTS;
import edu.aku.abdulsajid.template.core.MainApp;
import edu.aku.abdulsajid.template.data.AppDatabase;
import edu.aku.abdulsajid.template.data.DAO.GetFncDAO;
import edu.aku.abdulsajid.template.data.entities.Forms;
import edu.aku.abdulsajid.template.databinding.ActivityMainBinding;
import edu.aku.abdulsajid.template.get.db.GetAllDBData;
import edu.aku.abdulsajid.template.get.server.GetAllData;
import edu.aku.abdulsajid.template.sync.SyncAllData;
