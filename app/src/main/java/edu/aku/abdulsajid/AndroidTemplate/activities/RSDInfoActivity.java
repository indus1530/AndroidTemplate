package edu.aku.abdulsajid.AndroidTemplate.activities;
...
import edu.aku.abdulsajid.AndroidTemplate.R;
import edu.aku.abdulsajid.AndroidTemplate.RMOperations.crudOperations;
import edu.aku.abdulsajid.AndroidTemplate.core.MainApp;
import edu.aku.abdulsajid.AndroidTemplate.data.DAO.FormsDAO;
import edu.aku.abdulsajid.AndroidTemplate.data.DAO.GetFncDAO;
import edu.aku.abdulsajid.AndroidTemplate.data.entities.District;
import edu.aku.abdulsajid.AndroidTemplate.data.entities.FacilityProvider;
import edu.aku.abdulsajid.AndroidTemplate.data.entities.Forms;
import edu.aku.abdulsajid.AndroidTemplate.data.entities.Tehsil;
import edu.aku.abdulsajid.AndroidTemplate.databinding.ActivityRsdinfoBinding;
import edu.aku.abdulsajid.AndroidTemplate.get.db.GetAllDBData;
import edu.aku.abdulsajid.AndroidTemplate.get.db.GetIndDBData;
import edu.aku.abdulsajid.AndroidTemplate.utils.DateUtils;
import edu.aku.abdulsajid.AndroidTemplate.validation.ClearClass;
import edu.aku.abdulsajid.AndroidTemplate.validation.validatorClass;
