...
import edu.aku.abdulsajid.AndroidTemplate.appVersion.VersionAppContract;
import edu.aku.abdulsajid.AndroidTemplate.core.CONSTANTS;
import edu.aku.abdulsajid.AndroidTemplate.core.MainApp;
import edu.aku.abdulsajid.AndroidTemplate.data.AppDatabase;
...
import edu.aku.abdulsajid.AndroidTemplate.databinding.ActivityMainBinding;
import edu.aku.abdulsajid.AndroidTemplate.get.db.GetAllDBData;
import edu.aku.abdulsajid.AndroidTemplate.get.server.GetAllData;
import edu.aku.abdulsajid.AndroidTemplate.sync.SyncAllData;
